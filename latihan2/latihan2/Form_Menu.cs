...
namespace latihan2
{
    public partial class Form_Menu : Form
    {
        ...
        void hasiltransaksi(string harga, object pilih_barang, object jumlah)
        {
            ...
            {
                SqlCommand cmd = koneksi.CreateCommand();
                cmd = new SqlCommand("INSERT INTO tbl_transaksi (pilih_barang, jumlah, harga, total) VALUES (@pilih_barang, @jumlah, @harga, @total)", koneksi);

                cmd.Parameters.AddWithValue("@pilih_barang", dgv_transaksi.Rows[i].Cells[0].Value.ToString());
                cmd.Parameters.AddWithValue("@jumlah", dgv_transaksi.Rows[i].Cells[1].Value.ToString());
                cmd.Parameters.AddWithValue("@harga", dgv_transaksi.Rows[i].Cells[2].Value.ToString());
                cmd.Parameters.AddWithValue("@total", dgv_transaksi.Rows[i].Cells[3].Value.ToString());
